...
class RejectPatternTest < Minitest::Test
  ...
  def test_remove_vowels
    ...
    letters.each do |letter|
      remaining << letter unless letter["a", "e", "i", "o", "u"]
      end
  ...
  def test_remove_words_containing_e
    ...
    remaining = []
    words.each do |word|
      remaining << word unless word.include?('e')
      end
  ...
  def test_remove_dinosaurs
    ...
    animals.each do |animals|
      remaining << animal unless animal.include?('saurus')
      end
  ...
  def test_remove_numbers
    ...
    elements.each do |element|
      remaining << element unless element.is_a?("String" == false)
      end
  ...
  def test_remove_floats
    ...
    remaining = []
    elements.each do |element|
      remaining << element unless element != float 
      end
  ...
  def test_remove_capitalized_words
    ...
    remaining = []
    words.each do |word|
      remaining << word unless word.capitalized? 
      end
